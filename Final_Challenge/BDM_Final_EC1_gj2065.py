...
if __name__ == '__main__':
    ...
    spark = SparkSession.builder.appName("BDM_Final_EC1_gj2065").getOrCreate()
    ...
    result = spark.createDataFrame(weekly_patterns_data.map(lambda x: distances(x, map_cbg_lat_lon)) \
        .groupByKey() \
